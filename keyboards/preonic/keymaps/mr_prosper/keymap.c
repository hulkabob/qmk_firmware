 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | Alt  | Brite| GUI  |Lower |    Space    |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
...
[_LOWER] = LAYOUT_preonic_grid( \
  ...
  _______,_______,_______, _______, KC_INSERT, KC_PSCREEN, _______,S(KC_NUHS),S(KC_NUBS),KC_HOME, KC_END, _______, \
